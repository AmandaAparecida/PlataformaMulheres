...
export function NotificationsPanel({ isOpen, onClose, userType }: NotificationsPanelProps) {
  const candidateNotifications: Notification[] = [
    ...
    },
    {
      ...
      message: "Design Studios enviou uma mensagem sobre sua candidatura.",
      time: "2h atrás",
      read: false,
    ...
    },
    {
      ...
      message: "Sua candidatura para 'Product Designer' foi visualizada pela empresa.",
      time: "1 dia atrás",
      read: true,
  ...
  const companyNotifications: Notification[] = [
    ...
    },
    {
      ...
      type: "update",
      title: "Prazo de vaga",
      message: "A vaga 'UX Researcher' fecha em 3 dias.",
      time: "3h atrás",
      read: true,

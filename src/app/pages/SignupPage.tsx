...
import logoIaraName from '../../imports/image-6.png';
...
export function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FFFBFC] flex font-sans overflow-hidden">
      {/* Esquerda: Formulário */}
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 sm:px-16 xl:px-24 py-12 relative z-10 overflow-y-auto">
        <Link
          to="/"

...
export function LoginPage() {
  ...
  const handleGoogleSignIn = () => {
    // Simula a autenticação com a conta Google do usuário
    navigate('/dashboard/candidata');
  };
            ...
            {activeTab === 'candidata' ? (
              <div className="space-y-6">
                <p className="text-center text-sm text-slate-600 mb-2">
                  Acesse sua conta com segurança através da sua conta Google de forma instantânea.
                </p>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                ...
                <p className="text-center text-sm text-slate-600 mt-6">
                  Ainda não tem conta?{' '}
                  <Link to="/cadastro?tab=empresa" className="font-semibold text-[#AC1634] hover:text-[#5B002C] transition-colors">

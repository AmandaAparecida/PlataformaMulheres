          ...
          >
            <div className="flex justify-between items-end mb-4">
              <div>
                ...
                <p className="text-slate-500 mt-1">Conclua seu perfil para aumentar o match com as melhores vagas.</p>
              </div>
                ...
                <div key={idx} className="bg-white/10 backdrop-blur-sm border border-white/10 rounded-xl p-4 hover:bg-white/20 transition-all cursor-pointer">
                  ...
                  <div className="flex items-center justify-between mt-4 pt-4 border-t border-white/10">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-emerald-400 font-bold text-sm">{job.match}% Match</span>
                    </div>
